...
// Cấu hình Menu khớp với tên file tiếng Anh của bạn
const doctorMenu = [
    {
        title: 'Tổng quan',
        path: '/doctor/dashboard', // Trỏ đến DoctorDashboard.jsx
        icon: <LayoutDashboard size={20} />,
    },
    {
        title: 'Lịch hẹn của tôi',
        path: '/doctor/my-appointments', // Trỏ đến MyAppointmentsD.jsx
        icon: <CalendarCheck size={20} />,
    },
    {
        title: 'Bệnh nhân',
        path: '/doctor/patients', // Trỏ đến PatientsD.jsx
        icon: <Users size={20} />,
    },
    {
        title: 'Hồ sơ bệnh án',
        path: '/doctor/medical-records', // Trỏ đến MedicalRecordD.jsx
        icon: <ClipboardList size={20} />,
    },
    {
        title: 'Hồ sơ cá nhân',
        path: '/doctor/profile', // Trỏ đến ProfileD.jsx
