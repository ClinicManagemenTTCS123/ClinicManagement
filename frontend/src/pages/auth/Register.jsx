            ...
            <span className="text-xl font-black tracking-tighter text-slate-900 flex items-center">
                ...
                <span className="ml-1 bg-gradient-to-r from-[#3fa2d7] to-[#1e60a3] bg-clip-text text-transparent">
                    ...
                    <p className="text-[#6b7280] text-[15px]">
                        Đăng ký để truy cập Hệ thống Quản lý Phòng khám
                    </p>
                </div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full pl-11 pr-4 py-3 rounded-xl border ${
                                    errors.fullName ? 'border-red-400 focus:border-red-500 focus:ring-red-100' : 'border-gray-200 focus:border-[#54bced] focus:ring-[#e6f4fb]'
                                } outline-none transition-all text-[15px] placeholder:text-gray-400 focus:ring-4`}
                                {...register('fullName')}
                            />
                        </div>
                        {errors.fullName && (
                            <p className="text-[#e74c3c] text-sm mt-1.5 ml-1">{errors.fullName.message}</p>
                        )}
                    </div>
                    ...
                    <div>
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full pl-11 pr-12 py-3 rounded-xl border ${
                                    errors.confirmPassword ? 'border-red-400 focus:border-red-500 focus:ring-red-100' : 'border-gray-200 focus:border-[#54bced] focus:ring-[#e6f4fb]'
                                } outline-none transition-all text-[15px] placeholder:text-gray-400 focus:ring-4`}
                        ...
                        {errors.confirmPassword && (
                            <p className="text-[#e74c3c] text-sm mt-1.5 ml-1">{errors.confirmPassword.message}</p>
                        )}
                    </div>
                ...
                <div className="mt-8 text-center text-[15px] text-gray-500">
                    Bạn đã có tài khoản?{' '}
                    <a href="/login" className="text-[#54bced] hover:underline font-medium">
                        Đăng nhập
                    </a>
                </div>
            </div>
