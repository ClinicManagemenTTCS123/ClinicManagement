...
export default function LoginForm() {
    ...
    const onSubmit = async (data) => {
        try {
            ...
            const errorMsg = error.response?.data || "Đăng nhập thất bại! Kiểm tra lại tài khoản.";
            alert(errorMsg);
        }
    };
        ...
        <div className="min-h-screen bg-[#eaf5fa] flex items-center justify-center p-4 font-sans">
            <div className="bg-white w-full max-w-[440px] rounded-[24px] p-10 shadow-sm border border-gray-50">
                <div className="flex flex-col items-center text-center mb-8">
                    ...
                    <h1 className="text-[26px] font-bold text-[#1f2937] tracking-tight mb-2">Chào mừng quay lại</h1>
                    <p className="text-[#6b7280] text-[15px]">Đăng nhập để truy cập hệ thống quản lý phòng khám</p>
                </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                    ...
                    <div>
                        ...
                        <div className="flex justify-end mt-2">
                            <a href="/forgot-password" className="text-sm text-[#54bced] hover:underline">Quên mật khẩu?</a>
                        </div>
                    </div>
                ...
                <div className="mt-8 text-center text-[15px] text-gray-500">
                    Chưa có tài khoản? <a href="/register" className="text-[#54bced] hover:underline font-medium">Đăng ký</a>
                </div>
            </div>
        </div>
    );
