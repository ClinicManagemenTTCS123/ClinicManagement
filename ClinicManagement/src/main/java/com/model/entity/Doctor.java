...
public class Doctor {
    ...
    @Column(name = "full_name", nullable = false) // Đã sửa: full_name
    ...
    @Column(name = "date_of_birth", nullable = false) // Đã sửa: date_of_birth
    ...
    @Column(name = "consultation_fee") // Đã sửa: consultation_fee
